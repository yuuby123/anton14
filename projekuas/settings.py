"""
Django settings for projekuas project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-&bg*t=5z$_7^1)@5iy$+3x%^sz!=(hkvyd!3-$gasw3en48e9g')
...
WSGI_APPLICATION = 'projekuas.wsgi.application'
